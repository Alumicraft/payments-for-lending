...
# 5-digit account numbers for all leaf accounts and colon-parent sub-groups.
# Scheme: root X0000, group X0Y00, leaf X0YZZ
ACCOUNT_NUMBERS = {
    # ── Bank Accounts (10100) ──────────────────────────────────────────
    "Chase Checking 9016 (Trust)":           "10101",
    "Chase Checking 8778 (General)":         "10102",
    "Chase Savings 8804":                    "10103",
    "BSC Checking 3429 (General)":           "10104",
    "BSC IntraFi":                           "10105",
    "Chase Prime Money Market Fund (Sweep)": "10106",
    "CBC MM":                                "10107",
    # ── Current Assets (10200) ────────────────────────────────────────
    "Accounts Receivable (NON QBO)":         "10201",
    "Loans Receivable":                      "10202",
    "Loan Receivable - Tenaja Heights":      "10203",
    "Northpoint":                            "10204",
    "DCR":                                   "10205",
    "Country Place":                         "10206",
    "MV04":                                  "10207",
    ...
    "DSAK":                                  "10212",
    "Atherton":                              "10213",
    "Williams Trust":                        "10214",
    "21st Funding":                          "10215",
    "Prepaid Expenses":                      "10220",
    # ── Other Assets (10300) ──────────────────────────────────────────
    "Deposits":                              "10301",
    # ── Accounts Payable (20100) ──────────────────────────────────────
    "Accounts Payable (non-QBO)":            "20101",
    "Accounts Payable - Affordable":         "20102",
    # ── Credit Cards (20200) ──────────────────────────────────────────
    "Chase Credit 6120":                     "20201",
    # ── Current Liabilities (20300) ───────────────────────────────────
    "Deposit on Hand  PB":                   "20301",
    "Deposit on Hand RI":                    "20302",
    "Dealer Prepaid Interest":               "20303",
    "Payroll Liabilities":                   "20304",
    "401 K Deductions":                      "20305",
    # ── Long Term Liabilities (20400) ─────────────────────────────────
    "Loan Payable MV04":                     "20401",
    "Loan Payable GNJ":                      "20402",
    "Loan Payable Gould FT":                 "20403",
    "Loan Payable SJK":                      "20404",
    "Judd RR Loan Payable":                  "20405",
    "SWMH Loan Payable":                     "20406",
    "Atherton Loan Payable":                 "20407",
    "Williams Trust Loan Payable":           "20408",
    # ── Equity (30000, no sub-group) ──────────────────────────────────
    "Equity Draw":                           "30001",
    "Retained Earnings":                     "30002",
    # ── Direct Income (40100) ─────────────────────────────────────────
    "Revenue":                               "40101",
    "Flooring Interest Income":              "40102",
    "MH Sales":                              "40103",
    "Retail Commision":                      "40104",
    "Rebates":                               "40105",
    "Cavco Rebates":                         "40106",
    "Champion Rebates":                      "40107",
    "Fleetwood Rebates":                     "40108",
    "Closing Costs":                         "40109",
    "Service/Fee Income":                    "40110",
    # ── Other Income (40200) ──────────────────────────────────────────
    "Int/Div Income":                        "40201",
    # ── Cost of Goods Sold (50100) ────────────────────────────────────
    "Inspections":                           "50101",
    "Licenses & Permits":                    "50102",
    "Warehouse Line Fees":                   "50103",
    "Cavco West":                            "50104",
    "Closing Cost":                          "50105",
    "Cavco Durango":                         "50106",
    "Rebate Costs":                          "50107",
    "New Home Sale":                         "50108",
    "Origination Fees":                      "50109",
    "Cost of Goods Other":                   "50110",
    "COGS Install":                          "50111",
    # ── Operating Expenses direct leaves (50200) ──────────────────────
    "Automobile Expense":                    "50201",
    "Auto Lease":                            "50202",
    "Fuel":                                  "50203",
    "Maintenance":                           "50204",
    "Registration":                          "50205",
    "Telephone & Internet":                  "50206",
    "Property Taxes":                        "50207",
    "Use Tax":                               "50208",
    "Software & Subscription Svcs":          "50209",
    "Dues & Subscriptions":                  "50210",
    "Continuing Education":                  "50211",
    "Filing Fees":                           "50212",
    "Merchant Fees":                         "50213",
    "Bank Service Charges":                  "50214",
    "Charitable Donations":                  "50215",
    "Interest Expenses":                     "50216",
    "Insurance Expense":                     "50217",
    "Office Supplies":                       "50218",
    "Postage & Delivery":                    "50219",
    "Repairs & Maintenance":                 "50220",
    # ── Salaries & Benefits sub-group (50230) ─────────────────────────
    "Salaries & Benefits":                   "50230",
    "Wages":                                 "50231",
    "ER Payroll Taxes":                      "50232",
    "Benefits":                              "50233",
    "Paid Time Off":                         "50234",
    "Commissions/Bonuses":                   "50235",
    "Payroll Processing Fees":               "50236",
    "Other Payroll Expenses":                "50237",
    # ── Professional & Outsourced Svcs sub-group (50240) ──────────────
    "Professional & Outsourced Svcs":        "50240",
    "Accounting":                            "50241",
    "Consulting Services":                   "50242",
    "Outside Services":                      "50243",
    "Legal":                                 "50244",
    "Recruiting":                            "50245",
    "Other Professional Services":           "50246",
    # ── Sales & Marketing sub-group (50250) ───────────────────────────
    "Sales & Marketing":                     "50250",
    "Advertising & Promotion":               "50251",
    "Tradeshow & Event Expense":             "50252",
    "Printing & Reproduction":               "50253",
    "Graphic/Web Design/Promotional":        "50254",
    "Other Sales & Marketing":               "50255",
    # ── Travel & Entertainment sub-group (50260) ──────────────────────
    "Travel & Entertainment":                "50260",
    "Air & Rail":                            "50261",
    "Car Rental":                            "50262",
    "Lodging":                               "50263",
    "Business Meals":                        "50264",
    "Travel Meals":                          "50265",
    "Staff Meals":                           "50266",
    "Staff Meals - Local Office Work":       "50267",
    "Entertainment":                         "50268",
    "Other Travel Expense":                  "50269",
    # ── Facility Costs sub-group (50270) ──────────────────────────────
    "Facility Costs":                        "50270",
    "Rent Expense":                          "50271",
    "Park Space Rent":                       "50272",
    "Utilities":                             "50273",
    "Cleaning Services":                     "50274",
    # ── Other G&A sub-group (50280) ───────────────────────────────────
    "Other G&A":                             "50280",
    "Computer Hardware (non cap)":           "50281",
    "Bad Debt":                              "50282",
    # ── Other Expenses (50300) ────────────────────────────────────────
    "Other Expense - Loss on Investment":    "50301",
    "Interest Expense":                      "50302",
}
...
def import_chart_of_accounts(company, dry_run=False, limit=0):
    ...
    for parent_name, qbo_type in colon_parent_info.items():
        ...
        action, name = _create_account(
            name=parent_name,
            number=ACCOUNT_NUMBERS.get(parent_name),
            is_group=1,
            root_type=root_type,
    ...
    for row in rows:
        ...
        if ":" in acct_name:
            ...
            action, name = _create_account(
                name=child_part,
                number=ACCOUNT_NUMBERS.get(child_part, acct_number),
                is_group=0,
                root_type=root_type,
                account_type=account_type,
                parent_account=parent_account,
            ...
            action, name = _create_account(
                name=acct_name,
                number=ACCOUNT_NUMBERS.get(acct_name, acct_number),
                is_group=is_group,
                root_type=root_type,
                account_type=account_type,
                parent_account=parent_account,
