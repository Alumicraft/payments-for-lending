    ...
    },
    {
        ...
        "filters": [
            ["name", "in", [
                ...
                "Loan Application-dcr_loan_product",
                "Loan Application-dcr_loan_amount",
                "Loan Application-column_break_lending",
                "Loan Application-dcr_rate_of_interest",
                "Loan Application-dcr_repayment_amount",
                "Loan Application-dcr_total_payable_amount",
                "Loan Application-dcr_total_payable_interest",
                "Loan Application-dcr_company",
    ...
    },
    {
        ...
        "filters": [
            ["name", "in", [
                ...
                "Loan Application-loan_product-hidden",
                "Loan Application-loan_amount-hidden",
                "Loan Application-rate_of_interest-hidden",
                "Loan Application-column_break_7-hidden",
                "Loan Application-column_break_2-hidden",
                ...
                "Loan Application-company-hidden",
                "Loan Application-company-default",
                "Loan Application-repayment_amount-hidden",
                "Loan Application-total_payable_amount-hidden",
                "Loan Application-total_payable_interest-hidden",
            ]]
        ]
    },
]
